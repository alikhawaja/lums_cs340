...
ALTER DATABASE PartitionDB ADD FILE (Name = FG_Before01012018, FileName = '/var/opt/mssql/data/PartitionDB_FG_Before01012018.ndf') TO FILEGROUP FG_Before01012018

ALTER DATABASE PartitionDB ADD FILEGROUP FG_012018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_012018, FileName = '/var/opt/mssql/data/PartitionDB_012018.ndf') TO FILEGROUP FG_012018

ALTER DATABASE PartitionDB ADD FILEGROUP FG_022018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_022018, FileName = '/var/opt/mssql/data/PartitionDB_022018.ndf') TO FILEGROUP FG_022018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_032018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_032018, FileName = '/var/opt/mssql/data/PartitionDB_032018.ndf') TO FILEGROUP FG_032018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_042018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_042018, FileName = '/var/opt/mssql/data/PartitionDB_042018.ndf') TO FILEGROUP FG_042018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_052018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_052018, FileName = '/var/opt/mssql/data/PartitionDB_052018.ndf') TO FILEGROUP FG_052018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_062018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_062018, FileName = '/var/opt/mssql/data/PartitionDB_062018.ndf') TO FILEGROUP FG_062018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_072018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_072018, FileName = '/var/opt/mssql/data/PartitionDB_072018.ndf') TO FILEGROUP FG_072018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_082018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_082018, FileName = '/var/opt/mssql/data/PartitionDB_082018.ndf') TO FILEGROUP FG_082018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_092018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_092018, FileName = '/var/opt/mssql/data/PartitionDB_092018.ndf') TO FILEGROUP FG_092018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_102018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_102018, FileName = '/var/opt/mssql/data/PartitionDB_102018.ndf') TO FILEGROUP FG_102018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_112018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_112018, FileName = '/var/opt/mssql/data/PartitionDB_112018.ndf') TO FILEGROUP FG_112018
ALTER DATABASE PartitionDB ADD FILEGROUP FG_122018
ALTER DATABASE PartitionDB ADD FILE (Name = FG_122018, FileName = '/var/opt/mssql/data/PartitionDB_122018.ndf') TO FILEGROUP FG_122018
GO
...
ALTER DATABASE PartitionDB ADD FILE (Name = FG_012019, FileName = '/var/opt/mssql/data/PartitionDB_012019.ndf') TO FILEGROUP FG_012019
GO
